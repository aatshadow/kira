            ...
            <div className="flex flex-col items-center py-4">
              <div className="w-full mb-3">
                <Select value={selectedTaskId} onValueChange={(v) => setSelectedTaskId(v || '')}>
                  <SelectTrigger className="w-full h-12 md:h-10 bg-secondary text-sm">
                  ...
                  <SelectContent className="max-h-[40vh]">
                    {availableTasks.length === 0 ? (
                      ...
                      availableTasks.map((task) => (
                        <SelectItem key={task.id} value={task.id} className="py-2.5">
                          {task.title}
                        </SelectItem>
                      ))
                    )}
              ...
              <Button
                ...
                className="w-full h-12 md:h-10 bg-[#00D4FF] text-black hover:bg-[#00A8CC] hover:shadow-[0_0_8px_rgba(0,212,255,0.4)] disabled:opacity-30"
              >
