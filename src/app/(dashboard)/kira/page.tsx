...
import { Send, Loader2, Sparkles, CheckCircle2, AlertCircle, Plus, MessageSquare, Trash2 } from 'lucide-react'
...
export default function KiraPage() {
  ...
  const sendMessage = async (text?: string) => {
    ...
    try {
      ...
      // Update conversation ID (new conversation created server-side)
  ...
  return (
    <div className="py-8 flex gap-4" style={{ height: 'calc(100vh - 3.5rem - 5rem)' }}>
      ...
      <div className={cn(
        ...
        {/* Collapsed: just show new button */}
        {!showSidebar && (
